...
namespace RVO
{
    ...
    public:
        ...
        static Node1 moveAlongLine(const Node1 &start, const Node1 &middle, const Node1 &end, double ratio);
        static std::vector<Node1> processNodes(std::vector<Node1> path,double ratio);
    };
}
